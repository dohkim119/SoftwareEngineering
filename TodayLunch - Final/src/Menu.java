...
public class Menu extends Attribute {
	...
	public Menu(String name, int rice, int soup, int noodle, int bread, int meat, int spaicy, int oily,
			int hot, int sober, int nation, int fastFood, String fil, String position, String Sname) {
